...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
  ...
  const farmsList = useCallback(
    (farmsToDisplay): FarmWithStakedValue[] => {
      ...
      let farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.BGLPerBlock || 1)
  ...
  return (
    <>
      <Header>
        <Heading as="h1" size="xxl" color="BGL" mb="24px">
          {tokenMode
            ? TranslateString(10002, 'Stake tokens to earn BGL')
            : TranslateString(320, 'Stake LP tokens to earn BGL')}
        </Heading>
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback BGL and lock liquidity')}
        </Heading>
      </Header>
      <Page>
        <ControlContainer>
